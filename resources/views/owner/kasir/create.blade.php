            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('owner.store_kasir')}}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                            @csrf
                            <div class="row">
                                <div class="col-12">
                            ...
                            <button class="btn btn-primary text-white mt-4" type="submit">Tambah Kasir</button>
                        </form>
